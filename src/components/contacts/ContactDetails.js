				...
				<div className="contact-details-top">
					...
					<div className="contact-details-right">
						...
						<>
							...
							<div className="contact-details-line"><MdPhone className="contact-details-icon"/><input className="contact-form-input" placeholder="Phone" type="number" maxLength={45} onChange={(e) => setPhone(e.target.value)} value={phone}/></div>
